...
**13th**: Getting started, Introduction to Data Science (DS)

**20th**: The essentials of R programming, The DS workflow -- Part I: Import, Tidy and Transform
:::

::: {.slightlysmall .column width="25%"}
[**April**]{.class style="color:#3A5883"}

**10th/17th**: The DS workflow -- Part II: Visualize

**24th**: The DS workflow -- Part III: Model
:::

::: {.slightlysmall .column width="25%"}
[**May**]{.class style="color:#3A5883"}

**8th/18th/22nd/29th**: The DS workflow -- Part III: Model
:::

::: {.slightlysmall .column width="25%"}
[**June**]{.class style="color:#3A5883"}

**1st**: The DS workflow -- Part IV: Communicate

**12th**: Final presentations of the group projects
:::
:::::::
...
-   **20th March**: organize in teams, send team members via e-mail
-   **11th June**: Send presentations via e-mail
-   **26th June**: Hand in group project reports and peer reviews
:::
